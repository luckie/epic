...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		appID, err := epic.InstallPostgreSQLDatabase(adminUser, adminPassword, server, epicPassword)
		resetCreds()
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println("Epic database successfully created.")
			fmt.Println("Epic user created with password you provided.")
